 ...
 export default function Sucuri() {
    const router = useRouter();
     ...
     >
         ...
         <div className=" py-24 sm:py-12">
             <div className="mx-auto max-w-7xl px-6 lg:px-2">
                 <div className="mx-auto max-w-7xl lg:mx-0">
                     <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl text-center text-emerald-900">Sucurile digestive</h2>
                     ...
                     <p className="mt-0 text-lg text-grey-600">
                        ...
                        Primele 3 sunt produse de glandele anexe. <br/>
                        Ultimele două sunt produse de componentele tubului digestiv. <br/>
                     </p>
 
                     <div className="mx-auto mt-10 max-w-2x1 gap-x-8 gap-y-6 border-t border-green-900 pt-10 sm:mt-10 sm:pt-10 lg:mx-0 lg:max-w-none"></div>
 
                     <p className="mt-0 text-lg text-grey-600">
                        <span className="underline decoration-wavy text-[#65a30d] font-extrabold">Saliva</span> <br/>
                        <span className="underline decoration-double text-green-700">Conține:</span> <br/>
                        - apă <br/>
                        - mucus <br/>
                        - ioni minerali <br/>
                     ...
                     <p className="mt-0 text-lg text-grey-600">
                        <span className="underline decoration-wavy text-[#65a30d] font-extrabold">Bila</span> <br/>
                    ...
                    <p className="mt-0 text-lg text-grey-600">
                        <span className="underline decoration-wavy text-[#65a30d] font-extrabold">Sucul gastric</span> <br/>
                        <span className="underline decoration-double text-green-700">Conține:</span> <br/>
                        - apă <br/>
                        - mucus <br/>
                        - ioni minerali <br/>
                    ...
                    <p className="mt-0 text-lg text-grey-600">
                        <span className="underline decoration-wavy text-[#65a30d] font-extrabold">Sucul pancreatic</span> <br/>
                        <span className="underline decoration-double text-green-700">Conține:</span> <br/>
                        - apă <br/>
                        - mucus <br/>
                        - ioni minerali <br/>
                    ...
                    <p className="mt-0 text-lg text-grey-600">
                        <span className="underline decoration-wavy text-[#65a30d] font-extrabold">Sucul intestinal</span> <br/>
                        <span className="underline decoration-double text-green-700">Conține:</span> <br/>
                        - apă <br/>
                        - mucus <br/>
                        - ioni minerali <br/>
        ...
        <span onClick={()=> void router.push('/10/nutritia-digestia/sistemul-digestiv')} className="inline-flex items-center px-4 py-2 mr-3 mb-8 text-sm font-medium text-lime-500 bg-white border border-lime-500 rounded-lg hover:bg-lime-500 hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <span onClick={()=> void router.push('/10/respiratia/respiratia-anaeroba')} className="inline-flex items-center px-4 py-2 mb-8 text-sm font-medium text-lime-500 bg-white border border-lime-500 rounded-lg hover:bg-lime-500 hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        Următoarea lecție
