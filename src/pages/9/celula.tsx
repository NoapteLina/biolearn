...
export  function Celula() {
    ...
    >
        <div
            className="relative left-[calc(50%-20rem)] aspect-[1155/678] w-[27.125rem] -translate-x-1 rotate-[30deg] bg-gradient-to-tr from-green-300 to-green-500 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
    ...
    >
        ...
        <div className="ml-5" >
            <h1 className=" text-center text-3xl font-extrabold text-[#15803d]">CELULA ȘI COMPOZIȚIA EI CHIMICĂ</h1>
            <div className="mt-4 ml-1">
                <div className="bg-green-300 rounded-md w-4/5 text-center"><span className="text-[#65a30d] font-extrabold">Definiție:</span> Celula este unitatea de bază, strcturală, funcțională și genetică a unui organism.
                </div> <br/>
                <span className="text-[#65a30d] font-extrabold">Funcțiile celulei:</span> <br/>
                ...
                <div className="bg-green-300 rounded-md w-4/5 text-center"><span className="underline decoration-wavy text-[#65a30d] font-extrabold"> Observație! </span> Forma este diferită în funcție de poziție și funcție. </div> <br/>
                <span className="text-[#65a30d] font-extrabold">Formele celulei:</span> <br/>
                - fusiformă <br/>
                - sferică <br/>
                - ovală <br/>
                - piramidală <br/>
                - stelată <br/>
                <span className="text-[#65a30d] font-extrabold">Compoziția chimică a celulei</span> <br/>
                Celula conține: <br/>
                - 60% apă <br/>
                ...
                <span className="text-[#65a30d] font-extrabold">Acizii nucleici</span> <br/>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <div className="mx-auto mt-5 grid max-w-2x2 grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
