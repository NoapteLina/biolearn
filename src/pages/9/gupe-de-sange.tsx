    ...
    return(
        ...
        <div className="" >
            ...
            <div className="mt-4 ml-1">
                ...
                <span className="font-extrabold">1. Tipul Drosophila</span> întâlnit la insecte, toate mamiferele (inclusiv la om) <br/>
                ...
                <span className="font-extrabold">2. Tipul Abrazas</span> (pasăre): întâlnit la fluturele de mătase, toate păsările, reptile, unii amfibieni. <br/>
                - Femelele sunt heterogametice, iar masculii homogametici. <br/>
                INFLUENȚA MEDIULUI ASUPRA EREDITĂȚII <br/>
                <span className="underline">MUTAGENEZA</span> = procesul de apariție a mutațiilor <br/>
                <span className="underline">MUTANT</span> = individul purtător de mutanți <br/>
                <span className="underline">MUTAȚIA GENETICĂ</span> = orice modificare în structura și funcția materialului genetic, care nu este o consecință a recombinării genetice. <br/>
                CLASIFICAREA MUTAȚIILOR <br/>
                ...
                După cantitatea de material genetic afectat întalnim: <br/>
                <span className="font-extrabold">1. Genice</span> <br/>
